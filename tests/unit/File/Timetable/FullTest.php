 ...
 * FullTest Class
 */
class FullTest extends AbstractTest
{
    protected function getObject()
    {
        return new \JCoded\AtocDataParser\File\Timetable\Full();
    }
