...
/**
 * ManualTrainsTest Class
 */
class ManualTrainsTest extends AbstractTest
{
    protected function getObject()
    {
        return new \JCoded\AtocDataParser\File\Timetable\ManualTrains();
    }
